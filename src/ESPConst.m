classdef ESPConst
    ...
    properties (Constant)
        ...
        CODE_CLASS_WEIGHTS = [ESPConst.CODE_CLASS_ALL_INTERICTAL 0.1; ESPConst.CODE_CLASS_ALL_PREICTAL 0.2; ESPConst.CODE_CLASS_ALL_ICTAL 0.3; ESPConst.CODE_CLASS_ALL_POSTICTAL 0.4]
